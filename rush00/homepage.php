...
<html>
	...
	<body>
		...
		<table class="shop_grid">
			<TR>
				<TD>
					<div id="p0" class="container"  STYLE="background: white">
						<img class="image" src="./assets/camping-pocket-fire-starter_4460x4460.jpg" alt="Pocket Fire Starter"style="width:200px;height:200px;">
						<div class="middle">
							<div class="text">Pocket Fire Starter</br>$1000</div>
						</div>
					</div>
				</TD>
				<TD>
				...
				<TD>
					<div id="p2"class="container"  STYLE="background: white">
						<img class="image" src="./assets/camping-waterproof-bag-orange_4460x4460.jpg" alt="Orange Waterproof Bag"style="width:200px;height:200px;">
						<div class="middle">
							<div class="text">Orange Waterproof Bag</br>$1000</div>
						</div>
					</div>
				</TD>
			</TR>
			<TR>
				<TD>
					<div id="p3" class="container"  STYLE="background: white">
						<img class="image" src="./assets/camping-product-shower_4460x4460.jpg" alt="Portable Shower"style="width:200px;height:200px;">
						<div class="middle">
							<div class="text">Portable Shower</br>$1000</div>
						</div>
					</div>
				</TD>
				<TD>
